    ...
    fetch(API_ENDPOINTS.SETTINGS)
      ...
      .then(data => {
        setSettings({
          ...
          // OpenRouter Advanced
          CLAUDE_MEM_OPENROUTER_MAX_CONTEXT_MESSAGES: data.CLAUDE_MEM_OPENROUTER_MAX_CONTEXT_MESSAGES || DEFAULT_SETTINGS.CLAUDE_MEM_OPENROUTER_MAX_CONTEXT_MESSAGES,
          CLAUDE_MEM_OPENROUTER_MAX_TOKENS: data.CLAUDE_MEM_OPENROUTER_MAX_TOKENS || DEFAULT_SETTINGS.CLAUDE_MEM_OPENROUTER_MAX_TOKENS,

          // System Configuration
          CLAUDE_MEM_SKIP_TOOLS: data.CLAUDE_MEM_SKIP_TOOLS || DEFAULT_SETTINGS.CLAUDE_MEM_SKIP_TOOLS,
          CLAUDE_MEM_LOG_LEVEL: data.CLAUDE_MEM_LOG_LEVEL || DEFAULT_SETTINGS.CLAUDE_MEM_LOG_LEVEL,
